...
/*   Updated: 2025/10/03 18:03:36 by apatvaka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// /*                                                +#+#+#+#+#+   +#+           */
// /*   Created: 2025/07/30 16:22:00 by apatvaka          #+#    #+#             */
// /*   Updated: 2025/10/03 17:59:55 by apatvaka         ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */

// #include "bulit_in.h"

// static char	*get_env_entry(t_env *node, int is_export)
// {
// 	char	*entry;
// 	char	*tmp_key;
// 	char	*tmp_value;
...
// 	while (current)
// 	{
// 		array[i] = get_env_entry(current, 0);
// 		if (!array[i])
// 		{
// 			while (i > 0)
// 				free(array[--i]);
